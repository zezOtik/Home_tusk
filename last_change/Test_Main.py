...
def test_randominfeik1():
    hashtable = dict([(0,1),(2,3),(3,4),(1,7)])
    size_n = 3
    size_m = 3
    i = randominfeik1(hashtable,size_n,size_m)
    if i != 0:
        print('Test_randominfeik_1 is correct')
    else:
        print('Test_randominfeik_1 is not correct')
...
def test_invertor_step():
    hashtable = dict([(0,1),(1,1),(3,1),(4,1),(5,1),(6,1),(7,1),(8,1)])
    size_n = 3
    size_m = 3
    i = 4
    hashtable = invertor_step(hashtable,i,size_n,size_m)
    if hashtable.get(i-1) != None and hashtable.get(i+1) != None and hashtable.get(i-m) != None and hashtable.get(i+m) != None:
        print('Test_invertor_step is not correct')
    else:
        print('Test_invertor_step is correct')

def test_re_invertor_step():
    hashtable = dict([(0,1),(2,1),(1,1),(4,1),(6,1),(8,1)])
    size_n = 3
    size_m = 3
    i = 3
    j = 1
    hashtable = re_invertor_step(hashtable,i,j,size_n,size_m)
    test_hashtable = dict([(0,1),(1,1),(2,1),(3,1),(5,1),(6,1),(7,1),(8,1)])

    if hashtable != test_hashtable:
        print("Test_re_invertor_step is not correct")
    ekse:
